...
//         time: "3 days ago",
//         avatar: "https://i.pravatar.cc/150?u=jessica",
//         text: "I've updated the design files with the latest component changes. The new button styles and form elements are now consistent across all screens. Please review when you get a chance.\n\nAlso, I'm thinking we should standardize our color palette a bit more. There are some inconsistencies in the shades we're using."
//       },
//       {
//         id: 'c2',
//         name: "Alex Morgan",
//         time: "2 days ago",
//         avatar: "https://i.pravatar.cc/150?u=alex",
//         text: "Thanks for the update, Jessica! I've reviewed the changes and they look great. I agree about the color palette - let's schedule a quick meeting to finalize the colors."
//       },
//       {
//         id: 'c3',
//         name: "Ryan Park",
...
//         text: "I've started implementing the new components in the codebase. The button and form components are now updated. I'll work on the navigation elements next."
//       }
//     ]
//   },
//   recent: [
//     { id: 'd1', title: "Design System Components", author: "Jessica Chen", time: "3 days ago", status: "Active", replies: 3 },
//     { id: 'd2', title: "API Integration Issues", author: "David Kim", time: "5 days ago", status: "Needs Input", replies: 7 },
//     { id: 'd3', title: "Project Timeline Updates", author: "Alex Morgan", time: "1 week ago", status: "Resolved", replies: 12 }
//   ],
//   teamActivity: [
//     { id: 'a1', user: "Jessica Chen", action: "started a new discussion", target: "Design System Components", time: "3 days ago", avatar: "https://i.pravatar.cc/150?u=jessica" },
//     { id: 'a2', user: "Alex Morgan", action: "replied to", target: "API Integration Issues", time: "4 days ago", avatar: "https://i.pravatar.cc/150?u=alex" },
//     { id: 'a3', user: "Ryan Park", action: "closed discussion", target: "Project Timeline Updates", time: "1 week ago", avatar: "https://i.pravatar.cc/150?u=ryan" }
//   ]
// };